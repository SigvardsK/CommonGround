        ...
        <div className="flex-1 p-6">
          <div className="max-w-[672px] mx-auto">
            ...
            <div className="space-y-3">
              ...
              <Button 
                variant="outline" 
                className="w-full flex items-center justify-between p-4 min-h-[72px] bg-card rounded-lg border hover:border-accent transition-colors font-normal"
              >
              ...
              {/* Agent List */}
              {[1, 2, 3].map((index) => (
                <div key={index} className="flex items-center justify-between p-4 min-h-[72px] bg-card rounded-lg border hover:border-accent transition-colors">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Associate agent specialized in web searching tasks.</p>
                    </div>
                  </div>
